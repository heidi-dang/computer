...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("superseded_by_id", sa.Text(), sa.ForeignKey("memory_records.id", ondelete="SET NULL"), nullable=True),
        sa.Column("source_event_ids", sa.JSON(), nullable=False, server_default="[]"),
        sa.Column("branch_id", sa.Text(), nullable=True),
        sa.Column("parent_memory_id", sa.Text(), sa.ForeignKey("memory_records.id", ondelete="SET NULL"), nullable=True),
    ...
    op.create_index("ix_memory_record_user_workspace_status", "memory_records", ["user_id", "workspace", "status"])
    op.create_index("ix_memory_record_user_hash", "memory_records", ["user_id", "workspace", "content_hash"])
    op.create_index("ix_memory_record_user_kind", "memory_records", ["user_id", "workspace", "kind", "status"])
    op.create_index("ix_memory_record_user_branch", "memory_records", ["user_id", "workspace", "branch_id", "status"])
    ...
    op.create_table(
        ...
        sa.Column("parent_checkpoint_id", sa.Text(), sa.ForeignKey("memory_checkpoints.id", ondelete="SET NULL"), nullable=True),
        sa.Column("created_at_ms", sa.BigInteger(), nullable=False),
        sa.Column("updated_at_ms", sa.BigInteger(), nullable=False),
        sa.UniqueConstraint("user_id", "workspace", "task_key", "version", name="uq_memory_checkpoint_task_version"),
    )
    op.create_index("ix_memory_checkpoint_task", "memory_checkpoints", ["user_id", "workspace", "task_key", "version"])
    ...
    op.create_table(
        ...
        sa.Column("created_at_ms", sa.BigInteger(), nullable=False),
        sa.Column("updated_at_ms", sa.BigInteger(), nullable=False),
        sa.UniqueConstraint("user_id", "workspace", "normalized_name", "entity_type", name="uq_memory_entity_name_type"),
    )
    op.create_index("ix_memory_entity_user_workspace", "memory_entities", ["user_id", "workspace", "status"])
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.Text(), sa.ForeignKey("users.id", ondelete="CASCADE"), nullable=False),
        sa.Column("workspace", sa.Text(), nullable=False, server_default=""),
        sa.Column("source_entity_id", sa.Text(), sa.ForeignKey("memory_entities.id", ondelete="CASCADE"), nullable=False),
        sa.Column("target_entity_id", sa.Text(), sa.ForeignKey("memory_entities.id", ondelete="CASCADE"), nullable=False),
        ...
        sa.Column("created_at_ms", sa.BigInteger(), nullable=False),
        sa.Column("updated_at_ms", sa.BigInteger(), nullable=False),
        sa.UniqueConstraint("user_id", "workspace", "source_entity_id", "target_entity_id", "relation", name="uq_memory_relationship"),
    )
    op.create_index("ix_memory_relationship_source", "memory_relationships", ["user_id", "workspace", "source_entity_id"])
    op.create_index("ix_memory_relationship_target", "memory_relationships", ["user_id", "workspace", "target_entity_id"])
    ...
    op.create_index("ix_memory_snapshot_user_workspace", "memory_snapshots", ["user_id", "workspace", "created_at_ms"])
    ...
    op.create_table(
        ...
        sa.Column("from_snapshot_id", sa.Text(), sa.ForeignKey("memory_snapshots.id", ondelete="SET NULL"), nullable=True),
        sa.Column("status", sa.Text(), nullable=False, server_default="active"),
        sa.Column("created_at_ms", sa.BigInteger(), nullable=False),
        sa.Column("updated_at_ms", sa.BigInteger(), nullable=False),
        sa.UniqueConstraint("user_id", "workspace", "name", name="uq_memory_branch_name"),
    )
    op.create_index("ix_memory_branch_user_workspace", "memory_branches", ["user_id", "workspace", "status"])
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.Text(), sa.ForeignKey("users.id", ondelete="CASCADE"), nullable=False),
        sa.Column("workspace", sa.Text(), nullable=False, server_default=""),
        sa.Column("memory_id", sa.Text(), sa.ForeignKey("memory_records.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_index("ix_memory_feedback_user_memory", "memory_retrieval_feedback", ["user_id", "memory_id", "created_at_ms"])
    op.create_index("ix_memory_feedback_context", "memory_retrieval_feedback", ["user_id", "context_id"])
    ...
    op.create_index("ix_memory_job_user_workspace", "memory_jobs", ["user_id", "workspace", "status"])

    op.create_table(
        "memory_embeddings",
        sa.Column("memory_id", sa.Text(), sa.ForeignKey("memory_records.id", ondelete="CASCADE"), primary_key=True, nullable=False),
        sa.Column("user_id", sa.Text(), sa.ForeignKey("users.id", ondelete="CASCADE"), nullable=False),
        sa.Column("workspace", sa.Text(), nullable=False, server_default=""),
    ...
    op.create_index("ix_memory_embedding_user_workspace", "memory_embeddings", ["user_id", "workspace"])
