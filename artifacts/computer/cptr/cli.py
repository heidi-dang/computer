...
def run(host: str, port: int, reload: bool, headless: bool):
    ...
    # A managed runtime can supply a stable first-run token through its
    # environment. Keep the original random-token behavior for every other
    # invocation.
    token = os.environ.get("CPTR_STARTUP_TOKEN") or secrets.token_hex(32)
